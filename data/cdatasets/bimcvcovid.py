...
from .cxrdataset import CXRDataset, H5Dataset
from .padchestmap import padchesttochexpert, padchesttochestxray14

padchesttochexpert = padchesttochexpert
...
padchesttochestxray14 = padchesttochestxray14
...
class BIMCVCOVIDDataset(H5Dataset, CXRDataset):
    ...
    def _set_datapaths(self):
        datapath = os.path.join(ROOT_DIR, 'datasets/covid/bimcv+')
        labelpath = 'derivatives/labels/labels_covid19_posi.tsv'
        self.unknown_label_path = os.path.join(ROOT_DIR, 'data/cdatasets/bimcv_covid_unknown_labels.txt')
        self.labeldf = pandas.read_csv(os.path.join(datapath, labelpath), delimiter='\t')
        self.h5path = os.path.join(datapath, 'bimcv+.h5')
        self.df = pandas.read_csv(os.path.join(datapath, 'bimcv+.csv'))
        self.manual_projection_label_path = os.path.join(ROOT_DIR, "cdatasets/bimcv_covid_manual_projection_labels.yml")
